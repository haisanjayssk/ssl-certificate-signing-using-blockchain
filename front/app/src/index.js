...
window.OraclizeContract = OraclizeContract;
var accounts;
var account;
...
window.App = {
  ...
  addEventListeners: async function (instance) {
    if (eventListened) {
      return;
    }
    var VerificationResult = await instance.VerificationResult({ fromBlock: 0, toBlock: 'latest' }, console.log);
  ...
  verify: function (hostname, publicKey) {
    ...
    OraclizeContract.deployed().then(function (instance) {
      ...
      console.log(meta)
      return meta.verifyhost.sendTransaction(hostname, publicKey, { from: accounts[0], gas: 1000000, value: web3.utils.toWei("5", "ether") });
  ...
  isVerified: function (hostname) {
    ...
    OraclizeContract.deployed().then(function (instance) {
      meta = instance;
      App.addEventListeners(instance);
      return meta.isVerified.sendTransaction(hostname, { from: accounts[0], gas: 1000000, value: web3.utils.toWei(0.01, "ether") });
    }).then(function (value) {
      console.log(value);
    }).catch(function (e) {
      console.log(e);
